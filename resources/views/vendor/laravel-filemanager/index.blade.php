...
<head>
  ...
  <meta name="theme-color" content="#0678CF">
  <!-- Windows Phone -->
  <meta name="msapplication-navbutton-color" content="#0678CF">
  <!-- iOS Safari -->
  <meta name="apple-mobile-web-app-status-bar-style" content="#0678CF">
