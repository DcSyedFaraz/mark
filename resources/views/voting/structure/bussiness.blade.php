                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('businesss.store') }}" method="POST">
                                            @csrf
                                            <div class="form-group">
                        ...
                        <div class="card text-dark card-has-bg click-col"
                            ...
                            <div class="card-img-overlay d-flex flex-column">
                                <div class="card-body">
                                    ...
                                    <small class="text-xs"><i class="far fa-clock"></i>
                                        {{ $business->updated_at->diffforhumans() }}</small>
                                    <br><br>
                                    <p>{{ $business->phone ?? '' }}</p>
                                    <p>{{ $business->email ?? '' }}</p>
                                    <a href="{{ $business->website ?? '#' }}"
                                        target="blank">{{ $business->website ?? '' }}</a>
                                    ...
                                    <p><span class="font-weight-bold">Category:</span> <span
                                            class="badge badge-primary">{{ $business->category ?? '' }} @if ($business->otherCategory != null)
                                                    ...
                                                    <div class="modal fade" id="editEventModal{{ $business->id }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('businesss.update', $business->id) }}"
...
@section('script')
    ...
    <script type="text/javascript">
        // Assuming your variable with autocomplete values is named autocompleteValues
